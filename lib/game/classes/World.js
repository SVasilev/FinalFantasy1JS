function World(spriteName, tileDataFile, phaserGame) {
  this.IMAGE_HEIGHT = 3840;
  this.IMAGE_WIDTH = 4240;
  this.TILE_SIZE = 16;

  this.sprite = phaserGame.add.tileSprite(0, 0, 1280, 720, spriteName);
  this.sprite.scale.setTo(4, 4);
  this.sprite.tilePosition.x = 1888;//3990;//1888;
  this.sprite.tilePosition.y = 1408;//3763;//1408;
  ...
  this.tiles = phaserGame.cache.getJSON(tileDataFile).tiles;
...
World.prototype.generateNextEncounterSteps = function() {
  this.nextEncounterSteps = Math.floor(Math.random() * 206) + 50;
};
