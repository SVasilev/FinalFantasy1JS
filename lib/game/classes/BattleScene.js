...
BattleScene.prototype._initBattleMenu = function() {
  ...
  this._onMenuSelect = function(menu, selectedOption) {
    ...
    var self = this;
    var currentUnitIndex = self._battleGround[self._turn]._unitsGroup.cursorIndex;
      ...
      case 'ItemHP+++':
        ...
        this._battleGround[this._turn].activate(true, function(unit) {
          unit.act(selectedOption, null, function() {
            self._battleGround[self._turn]._unitsGroup.cursorIndex = currentUnitIndex;
            self._endUnitTurn();
            menu.enabled = true;
          });
        });
...
BattleScene.prototype._aiMove = function() {
  ...
  this._battleGround._partyUnits._setCursorToUnit(randomIndex);
  setTimeout(function() {
