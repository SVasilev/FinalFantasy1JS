/* global alert, Phaser, BattleUnits, GameMenu, BattleGround, _ */
...
BattleScene.prototype._initBattleMenu = function() {
  ...
  this._battleMenu = new GameMenu(
    { background: 'menuBackground', cursor: 'menuCursor' },
...
BattleScene.prototype._updateCharacterList = function() {
  ...
  this._characterList = new GameMenu({ background: 'menuBackground', cursor: 'menuCursor' },
                        characterList, menuConfig, this.phaserGame);
