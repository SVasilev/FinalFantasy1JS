...
Party.prototype.previousTile = function(direction, pixels) {
  var negateDirection = { 'right': 'left', 'left': 'right', 'up': 'down', 'down': 'up' };
  this.moveWorld(negateDirection[direction], pixels);
...
Party.prototype.adjustScene = function(direction, pixels) {
  ...
  if (forbiddenTiles.indexOf(this.currentTile()) !== -1) {
    ...
    if ((this.currentTile() === 'grass' || this.currentTile() === 'cold') &&
