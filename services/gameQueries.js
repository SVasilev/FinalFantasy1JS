		...
		connection.query('SELECT * FROM user', function(error, rows, fields) {
			...
			else
			{
				var post = { 
					...
					password: CryptoJS.MD5(this.salt + request.query.password.toString()), //TODO Make it with CryptoJS
					created: new Date()
				};
